...
export default function WarrantyClaimDetailPage() {
    ...
    const totalWorkflows = useMemo(() => {
        return products.reduce(
            (acc, p) =>
                acc + (p.workflows ? Object.keys(p.workflows).length : 0),
            0,
        );
    }, [products]);
                ...
                buttonEnds: [
                    {
                        ...
                        onClick: () => {
                            if (claim) {
                                ...
                                antdMessage.warning(
                                    "Đang tải dữ liệu phiếu bảo hành...",
                                );
                            }
                        },
                        ...
                        ? [
                              {
                                  ...
                                  type: "default" as const,
                                  onClick: () =>
                                      (window.location.href = `tel:${claim?.phone}`),
                              },
                          ]
                        : []),
                    ...(claim?.status !== WarrantyClaimStatus.COMPLETED
                        ? [
                              ...
                              },
                              {
                                  ...
                                  onClick: () =>
                                      router.push(
                                          `/sale/warranty/${claimCode}/update`,
                                      ),
                              },
                          ]
                        : []),
                ...
                <Card>
                    ...
                    <div className="mt-2">
                        ...
                        <Text type="secondary" className="text-sm">
                            {completedWorkflows}/{totalWorkflows} công đoạn đã
                            hoàn thành
                        </Text>
                    </div>
                </Card>
                                ...
                                <Descriptions bordered column={1} size="small">
                                    ...
                                    <Descriptions.Item label="Đơn hàng gốc">
                                        <Button
                                            ...
                                            onClick={() =>
                                                router.push(
                                                    `/sale/orders/${claim?.originalOrderCode}`,
                                                )
                                            }
                                        >
                                    ...
                                    <Descriptions.Item label="Ngày tạo">
                                        {dayjs(claim?.orderDate).format(
                                            "DD/MM/YYYY HH:mm",
                                        )}
                                    </Descriptions.Item>
                                    <Descriptions.Item label="Ngày giao dự kiến">
                                        {dayjs(claim?.deliveryDate).format(
                                            "DD/MM/YYYY",
                                        )}
                                    </Descriptions.Item>
                                    ...
                                    <Descriptions.Item label="Nhân viên tạo">
                                        <Space>
                                            <Avatar size="small">
                                                {createdByMember?.name?.charAt(
                                                    0,
                                                ) ||
                                                    claim?.createdByName?.charAt(
                                                        0,
                                                    ) ||
                                                    "?"}
                                            </Avatar>
                            ...
                            !hasAllProductImages && (
                                <Alert
                                    ...
                                    description={
                                        <div>
                                            <Text>
                                                Bạn cần thêm ảnh sản phẩm cho
                                                tất cả sản phẩm trước khi xác
                                                nhận đơn. Các sản phẩm chưa có
                                                ảnh:
                                            </Text>
                                            <ul className="mt-2 ml-4">
                                                {productsWithoutImages.map(
                                                    (product) => (
                                                        <li key={product.id}>
                                                            <Text strong>
                                                                {product.name}
                            ...
                            !allWorkflowsCompleted && (
                                <Alert
                                    ...
                                    description={
                                        <div>
                                            <Text>
                                                Bạn cần hoàn thành tất cả công
                                                đoạn trước khi chuyển sang trạng
                                                thái "Tạm giữ". Tiến độ hiện
                                                tại: {completedWorkflows}/
                                                {totalWorkflows} công đoạn đã
                                                hoàn thành.
                                            </Text>
                                        </div>
                                    }
            ...
            <Row gutter={[16, 16]}>
                ...
                <Col xs={24} lg={10}>
                    <div className="space-y-3 flex flex-col lg:border-l lg:pl-4">
                        ...
                        {claimCode &&
                            claimStatus === WarrantyClaimStatus.IN_PROGRESS && (
                                <div className="mt-4 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                                    <div className="flex flex-col items-center gap-3">
                                        <Text
                                            strong
                                            className="text-yellow-700 text-center"
                                        >
                                            Mã QR bảo hành sản phẩm{" "}
                                            {product.name}
                                        </Text>
                            ...
                            claimStatus !== WarrantyClaimStatus.IN_PROGRESS && (
                                <div className="mt-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
                                    <div className="flex flex-col items-center gap-2">
                                        ...
                                        >
                                            Mã QR chỉ hiển thị khi phiếu bảo
                                            hành ở trạng thái "Đang thực hiện"
                                        </Text>
                                    </div>
                                </div>
                            )}
