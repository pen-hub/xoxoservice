...
const StaffInformationSection = ({ form }: { form: any }) => {
    return (
        <div className="">
            <div className="mb-3 pb-2 border-b border-gray-200">
                        ...
                        <Table
                            ...
                            columns={[
                                ...
                                },
                                {
                                    ...
                                    width: "25%",
                                    render: (value, record, index) => {
                                        const departmentCode = (record as any)
                                            .departmentCode;
    ...
    ({ mode, orderCode, onSuccess, onCancel }, ref) => {
        ...
        const onFinish = async (values: FormValues) => {
            ...
            try {
                ...
                if (customerType === "new") {
                    ...
                    if (values.email) {
                        const existingCustomerByEmail = Object.values(
                            customers,
                        ).find((c) => c.email && c.email === values.email);
        ...
        useEffect(() => {
            ...
            return () => {
                ...
                off(departmentsRef);
                off(customersRef);
                const groupsRef = dbRef(getDatabase(), "xoxo/customerGroups");
                off(groupsRef);
            };
        }, [mode, orderCode]);
                ...
                <div className="gap-6 flex flex-col">
                    ...
                    >
                        ...
                        <OrderTimingSection
                            ...
                            modal={modal}
                        />
                        <StaffInformationSection form={form} />
                    </Card>
